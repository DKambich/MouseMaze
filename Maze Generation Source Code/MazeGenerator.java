    ...
    public void removeWall(Cell a, Cell b) {
        if(a != null && b != null) {
            switch(a.getCol() - b.getCol()){
                case  1: a.pointers[3] = b;  b.pointers[1] = a; break;
                case -1: a.pointers[1] = b;  b.pointers[3] = a; break;
            }
            switch(a.getRow() - b.getRow()){
                case  1:  a.pointers[0] = b;  b.pointers[2] = a; break;
                case -1:  a.pointers[2] = b;  b.pointers[0] = a; break;
            }
        }
    }

    public Cell getCell(int row, int col) {
        return (row >= 0 && row < maze.cells.length && col >= 0 && col< maze.cells[0].length) ? maze.cells[row][col] : null;
    }
