...
public class Cell {
  protected boolean visited, isCurrent, isTouched;
  protected Cell[] pointers; //North --> East --> South --> West (Clockwise rotation)
  ...
  public void show(Graphics g) {
    ...
    if(isCurrent) {
      ...
      //Marks the cell as a touched cell(not necessarily visited), used mainly for Wilson algorithm
