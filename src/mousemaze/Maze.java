...
import mousemazeTemp.algorithms.AldousBroder;
import mousemazeTemp.algorithms.Backtracker;
import mousemazeTemp.algorithms.BinaryTree;
import mousemazeTemp.algorithms.Eller;
import mousemazeTemp.algorithms.GrowingTree;
import mousemazeTemp.algorithms.Hunter;
import mousemazeTemp.algorithms.Kruskal;
import mousemazeTemp.algorithms.Prim;
import mousemazeTemp.algorithms.Recursive;
import mousemazeTemp.algorithms.Sidewinder;
import mousemazeTemp.algorithms.Wilson;
...
public class Maze {
  ...
  public int mazeWidth = WINDOW_WIDTH - 1, mazeHeight = WINDOW_HEIGHT - 1, numCells = 16, speed = 30, mazeGen = 4;
  private final MazeGenerator[] generators = new MazeGenerator[] { new AldousBroder(this), new Backtracker(this),
      new BinaryTree(this), new Eller(this), new GrowingTree(this), new Hunter(this), new Kruskal(this), new Prim(this),
      new Recursive(this), new Sidewinder(this), new Wilson(this) };
  public Cell[][] cells;
  ...
  public void setup() {
    ...
    window.setLocation(Toolkit.getDefaultToolkit().getScreenSize().width / 2 - WINDOW_WIDTH / 2,
    ...
    eventTimer = new Timer(1000 / speed, e -> {
      updateWindow();
    });
    eventTimer.start();
  }
  ...
  public void generateMenuBar() {
    ...
    JMenu speed = new JMenu("1. Generation Speed"), size = new JMenu("2. Maze Size"),
        mazeStyle = new JMenu("3. Maze Style"), randomWalk = new JMenu("Random Walkers"),
        biased = new JMenu("Biased Trees"), mst = new JMenu("Minimum Spanning Trees"),
        special = new JMenu("Special Cases");

    // Speed Menu
    ButtonGroup group = new ButtonGroup();
    JRadioButtonMenuItem slow = new JRadioButtonMenuItem("Slow"), medium = new JRadioButtonMenuItem("Medium"),
        fast = new JRadioButtonMenuItem("Fast"), superFast = new JRadioButtonMenuItem("Super-Fast");
    ...
    JRadioButtonMenuItem[] buttons = new JRadioButtonMenuItem[] { new JRadioButtonMenuItem("4x4 Grid"),
        new JRadioButtonMenuItem("8x8 Grid"), new JRadioButtonMenuItem("16x16 Grid"),
        new JRadioButtonMenuItem("32x32 Grid"), new JRadioButtonMenuItem("50x50 Grid"),
        new JRadioButtonMenuItem("100x100 Grid") };
    ...
    JRadioButtonMenuItem[] styles = new JRadioButtonMenuItem[] {
        new JRadioButtonMenuItem("Aldous-Broder"), new JRadioButtonMenuItem("Backtracker"),
        new JRadioButtonMenuItem("Binary Tree"), new JRadioButtonMenuItem("Eller"),
        new JRadioButtonMenuItem("Growing Tree"), new JRadioButtonMenuItem("Hunter"),
        new JRadioButtonMenuItem("Kruskal"), new JRadioButtonMenuItem("Prim"),
        new JRadioButtonMenuItem("Recursive"), new JRadioButtonMenuItem("Sidewinder"),
        new JRadioButtonMenuItem("Wilson")
    };
